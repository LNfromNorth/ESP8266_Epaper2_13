...
void setup()
{
  ...
  printf("NewImage:Image and RYImage\r\n");
  ...
  EPD_7IN5B_V2_SendHalfBimage(0, Image);
  EPD_7IN5B_V2_SendHalfBimage(1, Image);
  ...
  EPD_7IN5B_V2_SendHalfRYimage(0, Image);
  EPD_7IN5B_V2_SendHalfRYimage(1, Image);
