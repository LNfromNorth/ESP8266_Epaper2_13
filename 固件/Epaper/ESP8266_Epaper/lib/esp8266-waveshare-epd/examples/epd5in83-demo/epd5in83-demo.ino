...
void setup()
{
  ...
  Paint_NewImage(BlackImage, EPD_5IN83_WIDTH, EPD_5IN83_HEIGHT / 2, 180, WHITE);
...
#if 1   //Not enough memory, sending in TWO times: black 2times
  //1.Select Image
  ...
  printf("EPD_Display\r\n");
  EPD_5IN83_SendHalfImage(0, BlackImage);
  EPD_5IN83_SendHalfImage(1, BlackImage);
