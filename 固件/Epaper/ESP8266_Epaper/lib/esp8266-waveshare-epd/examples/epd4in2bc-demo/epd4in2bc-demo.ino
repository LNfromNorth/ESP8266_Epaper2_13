...
void setup()
{
  ...
  Paint_NewImage(Image, EPD_4IN2BC_WIDTH, EPD_4IN2BC_HEIGHT / 2, 0, WHITE);
  ...
  EPD_4IN2BC_SendHalfBimage(0, Image);
  EPD_4IN2BC_SendHalfBimage(1, Image);
  ...
  EPD_4IN2BC_SendHalfRYimage(0, Image);
  EPD_4IN2BC_SendHalfRYimage(1, Image);
