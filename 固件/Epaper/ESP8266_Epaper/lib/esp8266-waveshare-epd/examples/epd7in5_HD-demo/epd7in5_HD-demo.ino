...
void setup() {
  ...
  Paint_NewImage(BlackImage, 880, 264, 0, WHITE);
  ...
  printf("EPD_Display\r\n");
  EPD_7IN5_HD_Display_half(BlackImage, 0);
  EPD_7IN5_HD_Display_half(BlackImage, 1);
  DEV_Delay_ms(2000);
#endif

#if 1   // Display arr
  printf("EPD_Display\r\n");
  EPD_7IN5_HD_Displaypart(gImage_7in5_HD, 135, 145, 240, 240);
  DEV_Delay_ms(2000);
